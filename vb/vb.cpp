...
static const XMVECTORF32 g_VBEpsilon = { 0.01f, 0.01f, 0.01f, 0.01f };
...
static const SimpleVertex s_cubeVB[] =
{
...
static const uint16_t s_cubeIB[] =
{
    3,1,0,
    2,1,3,
...
static const VSStarterKitVertex1 s_VSStarterKitVB1[] =
{
...
static const VSStarterKitVertex2 s_VSStarterKitVB2[] =
{
...
static const VBMedia g_VBMedia[] =
{
...
bool Test03()
{
    ...
    // GetElement
    {
        ...
        {
            auto e = reader->GetElement( "POSITION", 0 );
            if ( !e )
            {
                success = false;
            ...
            e = reader->GetElement( "POSITION", 1 );
            if ( e )
            {
                success = false;
...
bool Test04()
{
    ...
    // GetElement
    {
        ...
        {
            auto e = writer->GetElement( "POSITION", 0 );
            if ( !e )
            {
                success = false;
                printe( "ERROR: Failed to find POSITION0 element\n" );
            ...
            e = writer->GetElement( "POSITION", 1 );
            if ( e )
            {
                success = false;
                printe( "ERROR: Shouldn't find POSITION1 element\n" );
            ...
            e = writer->GetElement( "TEXCOORD", 0 );
            if ( !e )
            {
                success = false;
                printe( "ERROR: Failed to find TEXCOORD0 element\n" );
            ...
            e = writer->GetElement( "BINORMAL", 0 );
            if ( e )
            {
                success = false;
                printe( "ERROR: Shouldn't find POSITION1 element\n" );
            ...
            e = writer->GetElement( "BLENDWEIGHT", 0 );
            if ( !e )
            {
                success = false;
                printe( "ERROR: Failed to find BLENDWEIGHT element\n" );
