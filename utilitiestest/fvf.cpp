...
namespace
{
    ...
    constexpr D3DVERTEXELEMENT9 c_VertexPositionBeta1[] =
    {
        { 0,  0, D3DDECLTYPE_FLOAT3, D3DDECLMETHOD_DEFAULT, D3DDECLUSAGE_POSITION, 0 },
    ...
    constexpr D3DVERTEXELEMENT9 c_VertexPositionBeta2[] =
    {
        { 0,  0, D3DDECLTYPE_FLOAT3, D3DDECLMETHOD_DEFAULT, D3DDECLUSAGE_POSITION, 0 },
    ...
    constexpr D3DVERTEXELEMENT9 c_VertexPositionBeta3[] =
    {
        { 0,  0, D3DDECLTYPE_FLOAT3, D3DDECLMETHOD_DEFAULT, D3DDECLUSAGE_POSITION, 0 },
    ...
    constexpr D3DVERTEXELEMENT9 c_VertexPositionBeta4[] =
    {
        { 0,  0, D3DDECLTYPE_FLOAT3, D3DDECLMETHOD_DEFAULT, D3DDECLUSAGE_POSITION, 0 },
    ...
    constexpr D3DVERTEXELEMENT9 c_VertexPositionBeta5[] =
    {
        { 0,  0, D3DDECLTYPE_FLOAT3, D3DDECLMETHOD_DEFAULT, D3DDECLUSAGE_POSITION, 0 },
        { 0, 12, D3DDECLTYPE_FLOAT4, D3DDECLMETHOD_DEFAULT, D3DDECLUSAGE_BLENDWEIGHT, 0 },
    ...
    constexpr D3DVERTEXELEMENT9 c_VertexPositionBeta5Color[] =
    {
        { 0,  0, D3DDECLTYPE_FLOAT3,   D3DDECLMETHOD_DEFAULT, D3DDECLUSAGE_POSITION, 0 },
        { 0, 12, D3DDECLTYPE_FLOAT4,   D3DDECLMETHOD_DEFAULT, D3DDECLUSAGE_BLENDWEIGHT, 0 },
    ...
    constexpr D3DVERTEXELEMENT9 c_VertexPositionDual31Texture[] =
    {
        { 0,  0, D3DDECLTYPE_FLOAT3, D3DDECLMETHOD_DEFAULT, D3DDECLUSAGE_POSITION, 0 },
...
bool Test03()
{
    ...
    if (FVF::ComputeVertexSize(tooBigDecl.get(), MAXD3DDECLLENGTH + 2, 0) != 0)
    {
        success = false;
        printf("\nERROR: invalid args too big test failed\n");
    }
...
#pragma warning(suppress : 6385) // test forces invalid SAL usage
    ...
    if (FVF::ComputeFVF(tooBigDecl.get(), MAXD3DDECLLENGTH + 2) != 0)
    {
        success = false;
        printf("\nERROR: invalid args too big test failed\n");
    }
...
bool Test06()
{
    ...
    if (FVF::CreateDeclFromFVF(D3DFVF_XYZB5, decl) != 0)
    {
