...
// Cube
static const uint32_t s_cubePointReps[8] = 
{
    0, 1, 2, 3, 4, 5, 6, 7,
};
...
static const uint16_t s_cubeGSAdj16[3 * 12 * 2] =
{
    0, 3, 1, 6, 2, 7,
    0, 4, 3, 6, 1, 2,
    0, 5, 4, 6, 3, 1,
...
static const uint32_t s_cubeGSAdj32[3 * 12 * 2] =
{
    0, 3, 1, 6, 2, 7,
    0, 4, 3, 6, 1, 2,
    0, 5, 4, 6, 3, 1,
...
// Face-mapped cube
static const uint32_t s_fmCubePointReps[24] = 
{
    0, 1, 2, 3, 4, 5,
    6, 7, 7, 4, 0, 3,
    6, 5, 1, 2, 4, 5,
...
static const uint32_t s_fmCubePointRepsEps[24] = 
{
    19, 18, 22,  3, 16, 17,
    12, 7,   7, 16, 19,  3,
    12, 17, 18, 22, 16, 17,
...
static const uint16_t s_fmCubeGSAdj16[3 * 12 * 2] =
{
    3, 2, 1, 17, 0, 9,
    2, 12, 1, 0, 3, 20,
    6, 7, 4, 19, 5, 14,
...
static const uint32_t s_fmCubeGSAdj32[3 * 12 * 2] =
{
    3, 2, 1, 17, 0, 9,
    2, 12, 1, 0, 3, 20,
    6, 7, 4, 19, 5, 14,
...
// Tetrahedron
static const uint32_t s_tetraPointReps[4] = 
{
    0, 1, 2, 3,
};
...
static const uint16_t s_tetraGSAdj16[3 * 4 * 2] =
{
    0, 3, 1, 0, 2, 1,
    1, 0, 2, 1, 0, 2,
    2, 3, 0, 2, 3, 0,
...
static const uint32_t s_tetraGSAdj32[3 * 4 * 2] =
{
    0, 3, 1, 0, 2, 1,
    1, 0, 2, 1, 0, 2,
    2, 3, 0, 2, 3, 0,
...
// Unused
static const uint16_t s_unused16[ 12*3 ] =
{
    0, 1, 2,
    0, 3, 1,
    0, 4, 3,
...
static const uint32_t s_unused32[ 12*3 ] =
{
    0, 1, 2,
    0, 3, 1,
    0, 4, 3,
...
static const uint32_t s_unusedPR[8] = 
{
